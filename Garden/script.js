...
function createPetals() {
  ...
  document.addEventListener('click', (event) => {
    ...
    newFlower.style.left = `${event.clientX-30}px`; // Center flower on click
    newFlower.style.top = `${event.clientY-100}px`; // Center flower on click
